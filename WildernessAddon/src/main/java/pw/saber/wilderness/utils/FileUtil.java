package pw.saber.wilderness.utils;
...
public class FileUtil {
    ...
    public static void ExportResource(String resourceName) throws Exception {
        ...
        //String jarFolder;
        try {
            stream = WildernessAddon.class.getResourceAsStream(resourceName);//note that each / is a directory down in the "jar tree" been the jar the root of the tree
            if (stream == null) {
